(function() {
  ...
  Game.prototype.showBullets = function() {
    ...
    ctx.fill();
    ctx.beginPath();
    ctx.ellipse(15,750, 1, 7, 0, 0, 2*Math.PI);
    ctx.fill();
    ctx.beginPath();
    ctx.ellipse(20,750, 1, 7, 0, 0, 2*Math.PI);
    ctx.fill();
    ctx.translate(10,0);
    ctx.globalAlpha=1;

    ctx.fillText(bs, 10, 750);
    ctx.fillText(bs, 10.25, 750);
    ctx.fillText(bs, 9.75, 750);
    ctx.fillText(bs, 10, 750.25);
    ctx.fillText(bs, 10, 749.75);
    if (this.ship.piercing_shots){
      ctx.fillStyle = 'yellow';
      bs="+"+this.ship.piercing_shots;
      ctx.fillText(bs, 45, 750);
      ctx.fillText(bs, 45.25, 750);
      ctx.fillText(bs, 44.75, 750);
      ctx.fillText(bs, 45, 750.25);
      ctx.fillText(bs, 45, 749.75);
      ctx.fillText("+"+this.ship.piercing_shots, 45, 749.75);
    }
  };
